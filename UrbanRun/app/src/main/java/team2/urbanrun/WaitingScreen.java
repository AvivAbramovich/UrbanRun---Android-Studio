...
public class WaitingScreen extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            String res = (new ServletGetGameProperties().execute(GameID,myProfile.getId())).get();
        ...
        accept = (BitmapFactory.decodeResource(getResources(), R.drawable.accepted));
        declined = (BitmapFactory.decodeResource(getResources(), R.drawable.declined));
        //Check every second if someone's status has been changed
        tt = new TimerTask() {
            @Override
            public void run() {
                String res = null;
    ...
    private class FriendsListAdapter extends ArrayAdapter<String> {
        ...
        public FriendsListAdapter(Context context, int resource, int textViewResourceId, String[] _names, String[] _img, String[] _ids) {
            ...
            creator = (BitmapFactory.decodeResource(getResources(), R.drawable.creator));
        }
